...
public class AddEditBookValidatorDto : AbstractValidator<AddOrEditBookDto>
{

	public AddEditBookValidatorDto()
	{
		...
		.NotNull().NotEmpty().When(e => e.Operation == AddOrEditBookDto.OperationType.Add)
